...
exports.categoriaSeeder = void 0;
...
const categoriaSeeder = async () => {
    ...
    await prisma_1.prisma.subSubcategoria.deleteMany();
    await prisma_1.prisma.subcategoria.deleteMany();
    await prisma_1.prisma.categoria.deleteMany();
    for (const categoria of categoriasData) {
        await prisma_1.prisma.categoria.create({
            data: {
...
exports.categoriaSeeder = categoriaSeeder;
//# sourceMappingURL=seedCategoria.js.map